...
const RegisterTutor = () => {
    ...
    const handleInputChange = (
        ...
        if (name === "lastName" && (inputValue.length < 1 || inputValue.length > 255)) {
            setError(true);
        ...
        if (name === "birthDate" && new Date(inputValue).getTime() > new Date().getTime()) {
            setError(true);
        ...
        if (name === "password" && (inputValue.length < 8 || inputValue.length > 255)) {
            setError(true);
        ...
        setCreateDisabled(inputLength === 0 && firstNameError || lastNameError && emailError && passwordError && birthDateError)
    };
                ...
                <form className={`formRegister`}>
                    ...
                    <div>
                        <input
                            ...
                            onChange={(e) => handleInputChange(e, setFirstNameError, setFirstNameErrorMessage)}
                    ...
                    <div>
                        ...
                        />
                        {emailError && (
                            <p className="text-muted">{emailErrorMessage}</p>
                        )}
                    </div>
